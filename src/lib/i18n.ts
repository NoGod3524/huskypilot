...
const en = {
  ...
  "connect.helpStep5": "HuskyCT hands out one feed per course, so repeat this for every course you want on the dashboard — add them one at a time.",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "connect.helpStep5": "HuskyCT 是「一门课一条链接」，所以想放几门课就重复几次，一条一条加进来。",
