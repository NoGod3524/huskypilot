...
const en = {
  ...
  "connect.helpNote": "That link contains a private token. HuskyPilot never stores it — it is used once to read the calendar.",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "connect.helpNote": "该链接包含私人 token。HuskyPilot 不会保存它——只用一次来读取日历。",
