...
const en = {
  ...
  "privacy.label": "Private by design",
  "privacy.noPasswords": "No passwords",
  "privacy.noNetId": "No NetID access",
  "privacy.savedLocally": "Saved only in this browser",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "privacy.label": "隐私优先设计",
  "privacy.noPasswords": "无需密码",
  "privacy.noNetId": "无法访问 NetID",
  "privacy.savedLocally": "仅保存在此浏览器中",
